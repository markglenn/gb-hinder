...
pub static OPCODES: [Opcode; 0x100] = [
    ...
    Opcode::RLCA,
    Opcode::LD16(Target16::MImmediate, Target16::SP),
    ...
    Opcode::OR(Target::Immediate),
    Opcode::RST(0x30),
    Opcode::LDADD(Target16::HL),
